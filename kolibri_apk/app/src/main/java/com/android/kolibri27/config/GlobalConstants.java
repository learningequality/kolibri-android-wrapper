...
package com.android.kolibri27.config;

public class GlobalConstants {

    public static final String PYTHON_MAIN_SCRIPT_NAME = "kolibri.pex";
    ...
    public static final boolean IS_REMOTE_DEBUGGING = true; // need to set to false in production
    public static final boolean IS_KOLIBRI_DEBUGGING = true; // need to set to false in production
    public static final String LOG_TAG = "Kolibri27";
}
