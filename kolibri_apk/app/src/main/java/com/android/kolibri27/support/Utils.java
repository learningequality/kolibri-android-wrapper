...
package com.android.kolibri27.support;
...
public class Utils {
    ...
    public static boolean moveFile(InputStream inputStream, String dest, boolean replaceIfExists) {
        ...
        try {
            if (replaceIfExists) {
                ...
                try {
                    ...
                    if (!b) {
                        Log.d(GlobalConstants.LOG_TAG, "moveFile nothing to delete " + dest);
                    } else {
                        Log.d(GlobalConstants.LOG_TAG, "moveFile deleted " + dest);
                    }
                } catch (Exception e) {
                    Log.e(GlobalConstants.LOG_TAG, "moveFile failed to delete " + dest, e);
                }
            }
            ...
            Log.e(GlobalConstants.LOG_TAG, "File moving error, file not found", e);
            succeed = false;
        } catch (Exception e) {
            Log.e(GlobalConstants.LOG_TAG, "File moving error: ", e);
            succeed = false;
        }
        return succeed;
    }
